...
# ==========================================
# 🌐 พจนานุกรมและระบบแปลภาษา (Foreign -> Thai) [ปรับปรุงใหม่แก้ภาษาพม่าค้าง 100%]
# ==========================================
TRANSLATION_MAP = {
    # --- ภาษาพม่า (Myanmar) : เพิ่มแบบไม่เว้นวรรคและเว้นวรรคทุกรูปแบบ ---
    "သစ်သီးနို့စိမ်းဖျော်ရည်": "มะพร้าวนมสดปั่น",
    "သစ်သီး နို့စိမ်းဖျော်ရည်": "มะพร้าวนมสดปั่น",
    "ငှက်ပျောနို့အေး": "กล้วยนมสด",
    "ငှက်ပျော နို့အေး": "กล้วยนมสด",
    "လက်ဖက်ရည်စိမ်းပျားရည်သံပုရာ": "ชาเขียวน้ำผึ้งมะนาว",
    "လက်ဖက်ရည်စိမ်း ပျားရည် သံပုရာ": "ชาเขียวน้ำผึ้งมะนาว",
    "လက်ဖက်ရည် စိမ်း ပျားရည် သံပုရာ": "ชาเขียวน้ำผึ้งมะนาว",
    "ပျားသံပုရာလက်ဖက်ရည်စိမ်း": "ชาเขียวน้ำผึ้งมะนาว",
    "တိုင်ဝမ်နို့လက်ဖက်ရည်": "ชานมไต้หวัน",
    "တိုင်ဝမ် နို့လက်ဖက်ရည်": "ชานมไต้หวัน",
    "ဗနီလာနို့လက်ဖက်ရည်": "ชานมวนิลา",
    "ဗနီလာ နို့လက်ဖက်ရည်": "ชานมวนิลา",
    "ကာရာမဲလ်နို့လက်ဖက်ရည်": "ชานมคาราเมล",
    "ကာရာမဲလ် နို့လက်ဖက်ရည်": "ชานมคาราเมล",
    "ပျားရည်နို့လက်ဖက်ရည်": "ชานมน้ำผึ้ง",
    "ပျားရည် နို့လက်ဖက်ရည်": "ชานมน้ำผึ้ง",
    "လိုင်ချီးနို့လက်ဖက်ရည်": "ชานมลิ้นจี่",
    "လိုင်ချီး နို့လက်ဖက်ရည်": "ชานมลิ้นจี่",
    "ဖရဲသီးနို့လက်ဖက်ရည်": "ชานมเมล่อน",
    "ဖရဲသီး နို့လက်ဖက်ရည်": "ชานมเมล่อน",
    "စထရော်ဘယ်ရီနို့လက်ဖက်ရည်": "ชานมสตรอเบอร์รี่",
    "စထရော်ဘယ်ရီ နို့လက်ဖက်ရည်": "ชานมสตรอเบอร์รี่",
    "ပန်းသီးနို့လက်ဖက်ရည်": "ชานมแอปเปิ้ล",
    "ပန်းသီး နို့လက်ဖက်ရည်": "ชานมแอปเปิ้ล",
    "ကော်ဖီနို့လက်ဖက်ရည်": "ชานมกาแฟ",
    "ကော်ဖီ နို့လက်ဖက်ရည်": "ชานมกาแฟ",
    "ကိုကိုးနို့လက်ဖက်ရည်": "ชานมโกโก้",
    "ကိုကိုး နို့လက်ဖက်ရည်": "ชานมโกโก้",
    "အိုဗာတင်းနို့လက်ဖက်ရည်": "ชานมโอวัลติน",
    "အိုဗာတင်း နို့လက်ဖက်ရည်": "ชานมโอวัลติน",
    "ပိန်းဥနို့လက်ဖက်ရည်": "ชานมเผือก",
    "ပိန်းဥ နို့လက်ဖက်ရည်": "ชานมเผือก",
    "ထိုင်းကော်ဖီနက်": "โอเลี้ยง",
    "ထိုင်း ကော်ဖီနက်": "โอเลี้ยง",
    "ရှေးဟောင်းကော်ဖီ": "กาแฟโบราณ",
    "ရှေးဟောင်း ကော်ဖီ": "กาแฟโบราณ",
    "နက်စကော်ဖီ": "เนสกาแฟ",
    "လက်ဖက်ရည်နက်အေး": "ชาดำเย็น",
    "သံပုရာလက်ဖက်ရည်": "ชามะนาว",
    "သံပုရာ လက်ဖက်ရည်": "ชามะนาว",
    "ပျားသံပုရာလက်ဖက်ရည်နီ": "ชาแดงน้ำผึ้งมะนาว",
    "ထိုင်းနို့လက်ဖက်ရည်": "ชาไทยนม",
    "ထိုင်း နို့လက်ဖက်ရည်": "ชาไทยนม",
    "လက်ဖက်ရည်စိမ်းနို့": "ชาเขียวนม",
    "သံပုရာလက်ဖက်ရည်စိမ်း": "ชาเขียวมะนาว",
    "လက်ဖက်ရည်စိမ်း": "ชาเขียวใส",
    "ကိုကိုး": "โกโก้",
    "နို့န်းရောင်": "นมชมพู",
    "အိုဗာတင်း": "โอวัลติน",
    "ပျားရည်နို့စိမ်း": "นมสดน้ำผึ้ง",
    "ကာရာမဲလ်နို့စိမ်း": "นมสดคาราเมล",
    "နို့စိမ်း": "นมสดสีขาว",
    "စထရော်ဘယ်ရီလက်ဖက်ရည်": "ชาสตรอเบอร์รี่",
    "လိုင်ချီးလက်ဖက်ရည်": "ชาลิ้นจี่",
    "ဖရဲသီးလက်ဖက်ရည်": "ชาเมล่อน",
    "ပန်းသီးလက်ဖက်ရည်": "ชาแอปเปิ้ล",
    "ပိန်းဥနို့စိမ်းဖျော်ရည်": "เผือกนมสดปั่น",
    "အုန်းသီးနို့စိမ်းဖျော်ရည်": "มะพร้าวนมสดปั่น",
    "ဖရဲသီးနို့စိမ်းဖျော်ရည်": "เมล่อนนมสดปั่น",
    "ကန်စွန်းဥဝါနို့စိမ်းဖျော်ရည်": "มันม่วงนมสดปั่น",
    "စထရော်ဘယ်ရီနို့စိမ်းဖျော်ရည်": "สตรอเบอร์รี่นมสดปั่น",
    "ကိုကိုးဖျော်ရည်": "โกโก้ปั่น",
    "အိုဗာတင်းဖျော်ရည်": "โอวัลတင်ปั่น",
    "နို့စိမ်းဖျော်ရည်": "นมสดปั่น",
    "တိုင်ဝမ်နို့လက်ဖက်ရည်ဖျော်ရည်": "ชานมไต้หวันปั่น",
    "ထိုင်းနို့လက်ဖက်ရည်ဖျော်ရည်": "ชาไทยนมปั่น",
    "လက်ဖက်ရည်စိမ်းနို့ဖျော်ရည်": "ชาเขียวนมปั่น",
    "မက်ချာနို့စိမ်းဖျော်ရည်": "มัทฉะนมสดปั่น",
    "အမဲရာဘာလုံး": "ไข่มุกสีดำ",
    "အမဲ ရာဘာလုံး": "ไข่มุกสีดำ",
    "ရွှေရောင်ရာဘာလုံး": "ไข่มุกสีทอง",
    "ရွှေရောင် ရာဘာလုံး": "ไข่มุกสีทอง",
    "သစ်သီးစုံ": "ฟรุ้ตสลัด",
    "နို့ဂျယ်လီ": "บุกนมสด",
    "ကျောက်ကျောဂျယ်လီ": "บุกเฉาก๊วย",
    "ပျားရည်ဂျယ်လီ": "บุกน้ำผึ้ง",
    "သကြားညိုဂျယ်လီ": "บุกบราวน์ชูการ်",
    "အပိုမပါ": "ไม่ใส่ท็อปပิ้ง",
    "ပါဆယ်": "สั่งกลับบ้าน",
    "ဆိုင်မှာစားမည်": "ทานที่ร้าน",
...
def translate_to_thai(text):
    ...
    # เรียงลำดับคำแปลจากยาวไปสั้น เพื่อให้แปลคำเฉพาะ/คำผสมก่อน
    sorted_keys = sorted(TRANSLATION_MAP.keys(), key=len, reverse=True)

    # รอบที่ 1: เปลี่ยนคำตรงๆ
    ...
    # รอบที่ 2: คลีน space ส่วนเกิน และลองแมตช์อีกครั้งแบบลบ space
    ...
    # รอบที่ 3: แมตช์ภาษาพม่าแบบลบ space ทั้งหมด (แก้ปัญหาเว้นวรรคไม่ตรงกัน)
    nospace_text = clean_text.replace(" ", "")
    for foreign_str, thai_str in TRANSLATION_MAP.items():
        nospace_foreign = foreign_str.replace(" ", "")
        if len(nospace_foreign) > 2 and nospace_foreign in nospace_text:
            nospace_text = nospace_text.replace(nospace_foreign, thai_str)
            clean_text = nospace_text
